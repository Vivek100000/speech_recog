...
def mark_attendance(student_id):
    ...
    with open('attendance.csv', mode='a', newline='') as file:
        ...
        output_text.insert(tk.END, f"Attendance marked for: {student_id}\n")
...
def delete():
    ...
    delete_records.geometry("300x300")
...
def records():
    ...
    Button(records_window,text="close",command=lambda :records_window.destroy()).pack(pady=20)
...
Button(window,text="close",command=lambda: window.destroy()).pack(pady=20)
